...
describe('ProductsComponent', () => {
  ...
  beforeEach(() => {
    ...
    home = TestBed.inject<HomeService>(HomeService)
  ...
  it('should filter the data properly',()=>{
    fixture.detectChanges();
     component.electronics = prod.filter((x)=> x.category.includes(category[1].toLowerCase()));
